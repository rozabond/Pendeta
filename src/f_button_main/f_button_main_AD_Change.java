...
import g_button_main_folder.f_main_AD;
import g_button_main_folder.f_main_AD_B;
 ...
 * @author DELL
 */
public class f_button_main_AD_Change {
     JButton b = (new JButton("Change Password"));
     int wid;
     public f_button_main_AD_Change(int width_button){
     wid = width_button;
     g_button();   
    }
    private void g_button(){
                        ...
                        f_main_AD box = new f_main_AD(); 
                        f_main_AD_B box_input = new f_main_AD_B();     
