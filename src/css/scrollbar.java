...
public class scrollbar extends JScrollPane {
    ...
    //9/8/2021 finally finished matching up the colours
    private static final Color THUMB_COLOR = new Color(52,54,57);

    public scrollbar(Component view) {
        this(view, VERTICAL_SCROLLBAR_AS_NEEDED, HORIZONTAL_SCROLLBAR_AS_NEEDED);
    }

    public scrollbar(int vsbPolicy, int hsbPolicy) {
        this(null, vsbPolicy, hsbPolicy);
    }

    public scrollbar(Component view, int vsbPolicy, int hsbPolicy) {
    ...
    private static class ModernScrollBarUI extends BasicScrollBarUI {
        ...
        public ModernScrollBarUI(scrollbar sp) {
            this.sp = sp;
        }
    ...
    public static void main(String[] args) {
        ...
        frame.add(new scrollbar(content));
