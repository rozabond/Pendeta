...
public class f_family01_dpt {
   ...
   private void display_button(){
            ...
            s_sidebar1Aa_addbutton add_button = new s_sidebar1Aa_addbutton();
    ...
    protected void paintComponent(Graphics g)
    {
        ...
        super.paintComponent(g);
                        ...
                        hai.setPreferredSize(new Dimension(panel_width/2-75, panel_height/3 + 40));
